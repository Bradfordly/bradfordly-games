...
### dynamic dns ###
chmod +x /opt/gamehost/scripts/ddns.sh
bash /opt/gamehost/scripts/ddns.sh
cp /opt/gamehost/scripts/ddns.sh /etc/init.d/ddns.sh

### backup schedule ###
cp /opt/gamehost/scripts/backup.sh /etc/cron.daily/backup.sh
